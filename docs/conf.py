# -*- coding: utf-8 -*-
#
# KBase Data API documentation build configuration file, created by
# sphinx-quickstart on Tue Apr  7 10:11:40 2015.
#
...
copyright = u'2016 The KBase Project'
...
latex_documents = [
  (master_doc, 'KBaseDataAPI.tex', u'KBase Data API Documentation',
   u'Dan Gunter, Matt Henderson', 'manual'),
]
...
man_pages = [
    (master_doc, 'kbasedataapi', u'KBase Data API Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'KBaseDataAPI', u'KBase Data API Documentation',
   author, 'KBaseDataAPI', 'One line description of project.',
   'Miscellaneous'),
]
