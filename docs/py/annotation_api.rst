...
To create a new genome annotation object, you will create an object that
implements the interface
defined in :class:`doekbase.data_api.annnotation.genome_annotation.api.GenomeInterface`.
