...
class Iface(Interface):
  ...
  def get_features(token, ref, feature_tuple_list):
    """
...
class Client:
  ...
  def get_features(self, token, ref, feature_tuple_list):
    ...
    d = defer.maybeDeferred(self.send_get_features, token, ref, feature_tuple_list)
    d.addCallbacks(
...
class Processor(TProcessor):
  ...
  def process_get_features(self, seqid, iprot, oprot):
    ...
    iprot.readMessageEnd()
    result = get_features_result()
    d = defer.maybeDeferred(self._handler.get_features, args.token, args.ref, args.feature_tuple_list)
