...
class Client(Iface):
  ...
  def get_summary(self, token, ref):
    ...
    Parameters:
     ...
     - ref
    """
    self.send_get_summary(token, ref)
    return self.recv_get_summary()

  def send_get_summary(self, token, ref):
    self._oprot.writeMessageBegin('get_summary', TMessageType.CALL, self._seqid)
  ...
  def recv_get_summary(self):
    ...
    if result.type_exception is not None:
      raise result.type_exception
    raise TApplicationException(TApplicationException.MISSING_RESULT, "get_summary failed: unknown result");
  ...
  def save_summary(self, token, ref):
    ...
    Parameters:
     ...
     - ref
    """
    self.send_save_summary(token, ref)
    return self.recv_save_summary()

  def send_save_summary(self, token, ref):
    self._oprot.writeMessageBegin('save_summary', TMessageType.CALL, self._seqid)
  ...
  def recv_save_summary(self):
    ...
    if result.type_exception is not None:
      raise result.type_exception
    raise TApplicationException(TApplicationException.MISSING_RESULT, "save_summary failed: unknown result");
...
class Processor(Iface, TProcessor):
  ...
  def process_get_summary(self, seqid, iprot, oprot):
    ...
    result = get_summary_result()
    try:
      result.success = self._handler.get_summary(args.token, args.ref)
    except ServiceException, generic_exception:
      result.generic_exception = generic_exception
    except AuthorizationException, authorization_exception:
      result.authorization_exception = authorization_exception
  ...
  def process_save_summary(self, seqid, iprot, oprot):
    ...
    result = save_summary_result()
    try:
      result.success = self._handler.save_summary(args.token, args.ref)
    except ServiceException, generic_exception:
      result.generic_exception = generic_exception
    except AuthorizationException, authorization_exception:
      result.authorization_exception = authorization_exception
...
class get_summary_result(object):
  """
  Attributes:
   - success
   - generic_exception
...
class save_summary_args(object):
  """
  Attributes:
   - token
   - ref
...
class save_summary_result(object):
  """
  Attributes:
   - success
   - generic_exception
