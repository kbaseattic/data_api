...
class Feature_tuple:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'feature_type', None, None, ), # 1
    (2, TType.STRING, 'feature_id', None, None, ), # 2
  )

  def __init__(self, feature_type=None, feature_id=None,):
...
class Feature_id_mapping:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'by_type', (TType.STRING,None,TType.LIST,(TType.STRUCT,(Feature_tuple, Feature_tuple.thrift_spec))), {
    }, ), # 1
    (2, TType.MAP, 'by_region', (TType.STRING,None,TType.MAP,(TType.STRING,None,TType.MAP,(TType.STRING,None,TType.LIST,(TType.STRUCT,(Feature_tuple, Feature_tuple.thrift_spec))))), {
    }, ), # 2
    (3, TType.MAP, 'by_function', (TType.STRING,None,TType.LIST,(TType.STRUCT,(Feature_tuple, Feature_tuple.thrift_spec))), {
    }, ), # 3
    (4, TType.MAP, 'by_alias', (TType.STRING,None,TType.LIST,(TType.STRUCT,(Feature_tuple, Feature_tuple.thrift_spec))), {
    }, ), # 4
  )
  ...
  def write(self, oprot):
    ...
    if self.by_function is not None:
      ...
      for kiter120,viter121 in self.by_function.items():
        ...
        oprot.writeListBegin(TType.STRUCT, len(viter121))
