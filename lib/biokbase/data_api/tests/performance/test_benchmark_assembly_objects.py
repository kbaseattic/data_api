...
class TestBenchmarkAssemblyObjects(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.genome_annotation_api = biokbase.data_api.genome_annotation.GenomeAnnotationAPI(services=services["ci"])
        cls.assembly_api = biokbase.data_api.assembly.AssemblyAPI(services=services["ci"])
