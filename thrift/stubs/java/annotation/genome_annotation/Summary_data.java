...
public class Summary_data implements org.apache.thrift.TBase<Summary_data, Summary_data._Fields>, java.io.Serializable, Cloneable, Comparable<Summary_data> {
  ...
  private static final org.apache.thrift.protocol.TField ASEMBLY_SOURCE_DATE_FIELD_DESC = new org.apache.thrift.protocol.TField("asembly_source_date", org.apache.thrift.protocol.TType.STRING, (short)9);
   ...
   */
  public String asembly_source_date; // required
  /**
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
     ...
     * Date of origin the source indicates for the Assembly.
     */
    ASEMBLY_SOURCE_DATE((short)9, "asembly_source_date"),
    /**
     * GC content for the entire Assembly.
     */
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 9: // ASEMBLY_SOURCE_DATE
          return ASEMBLY_SOURCE_DATE;
        case 10: // GC_CONTENT
          return GC_CONTENT;
        case 11: // DNA_SIZE
          return DNA_SIZE;
  ...
  static {
    ...
    tmpMap.put(_Fields.ASSEMBLY_SOURCE_ID, new org.apache.thrift.meta_data.FieldMetaData("assembly_source_id", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.ASEMBLY_SOURCE_DATE, new org.apache.thrift.meta_data.FieldMetaData("asembly_source_date", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    ...
    Map<String,Long> feature_type_counts)
  {
    ...
    this.asembly_source_date = asembly_source_date;
  ...
  public Summary_data(Summary_data other) {
    ...
    if (other.isSetAsembly_source_date()) {
      this.asembly_source_date = other.asembly_source_date;
    }
   ...
   * Date of origin the source indicates for the Assembly.
   */
  public String getAsembly_source_date() {
    return this.asembly_source_date;
  }

  /**
   * Date of origin the source indicates for the Assembly.
   */
  public Summary_data setAsembly_source_date(String asembly_source_date) {
    this.asembly_source_date = asembly_source_date;
    return this;
  }

  public void unsetAsembly_source_date() {
    this.asembly_source_date = null;
  }

  /** Returns true if field asembly_source_date is set (has been assigned a value) and false otherwise */
  public boolean isSetAsembly_source_date() {
    return this.asembly_source_date != null;
  }

  public void setAsembly_source_dateIsSet(boolean value) {
    if (!value) {
      this.asembly_source_date = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ASEMBLY_SOURCE_DATE:
      if (value == null) {
        unsetAsembly_source_date();
      } else {
        setAsembly_source_date((String)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case ASEMBLY_SOURCE_DATE:
      return isSetAsembly_source_date();
    case GC_CONTENT:
  ...
  public boolean equals(Summary_data that) {
    ...
    boolean this_present_asembly_source_date = true && this.isSetAsembly_source_date();
    boolean that_present_asembly_source_date = true && that.isSetAsembly_source_date();
    if (this_present_asembly_source_date || that_present_asembly_source_date) {
      if (!(this_present_asembly_source_date && that_present_asembly_source_date))
        return false;
      if (!this.asembly_source_date.equals(that.asembly_source_date))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_asembly_source_date = true && (isSetAsembly_source_date());
    list.add(present_asembly_source_date);
    if (present_asembly_source_date)
      list.add(asembly_source_date);
  ...
  public int compareTo(Summary_data other) {
    ...
    lastComparison = Boolean.valueOf(isSetAsembly_source_date()).compareTo(other.isSetAsembly_source_date());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAsembly_source_date()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.asembly_source_date, other.asembly_source_date);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("asembly_source_date:");
    if (this.asembly_source_date == null) {
      sb.append("null");
    } else {
      sb.append(this.asembly_source_date);
    }
    first = false;
    if (!first) sb.append(", ");
  ...
  private static class Summary_dataStandardScheme extends StandardScheme<Summary_data> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Summary_data struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 9: // ASEMBLY_SOURCE_DATE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.asembly_source_date = iprot.readString();
              struct.setAsembly_source_dateIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Summary_data struct) throws org.apache.thrift.TException {
      ...
      if (struct.asembly_source_date != null) {
        oprot.writeFieldBegin(ASEMBLY_SOURCE_DATE_FIELD_DESC);
        oprot.writeString(struct.asembly_source_date);
        oprot.writeFieldEnd();
      }
  ...
  private static class Summary_dataTupleScheme extends TupleScheme<Summary_data> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Summary_data struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAsembly_source_date()) {
        optionals.set(8);
      }
